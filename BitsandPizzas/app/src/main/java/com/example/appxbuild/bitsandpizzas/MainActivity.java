package com.example.appxbuild.bitsandpizzas;
...
//Create the ActionBarDrawerToggle
        drawerToggle = new ActionBarDrawerToggle(this, drawerLayout,
            ...
            //Called when a drawer has settled in a completely open state. @Override
...
// update the main content by replacing fragments currentPosition = position;
        Fragment fragment;
        switch(position) {
...
// Sync the toggle state after onRestoreInstanceState has occurred.
    ...
    private void setActionBarTitle(int position) { String title;
        if (position == 0){
